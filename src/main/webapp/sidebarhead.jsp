        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="Controlador?menu=cliente">Cliente</a>
                        <a class="collapse-item" href="Controlador?menu=usuario&accion=Listar">Usuario</a>
                        <a class="collapse-item" href="Controlador?menu=proveedor">Servicio</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Elija opción:</h6>
                        <a class="collapse-item" href="Controlador?menu=NuevaVenta&accion=BuscarCliente">Cliente</a>
                        <a class="collapse-item" href="Controlador?menu=NuevaVenta&accion=BuscarClientel">Usuario</a>
                        <a class="collapse-item" href="Controlador?menu=NuevaVenta&accion=BuscarCliente">Servicio</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">${user.getNombres()}</span>
